...
export default function HomeScreen({ onNavigate, selectedLocation, theme, onToggleTheme, onNotifications, onMenu, user }) {
  ...
  return (
    <div className="screen home-screen">
      ...
      <div className="home-action-grid"><button className="btn-primary home-action" onClick={() => onNavigate("directions")}><Navigation size={17} /> Start Navigation</button><button className="btn-primary home-action secondary-action" onClick={() => onNavigate("report")}>+ Report a Hazard</button><button className="emergency-home-btn" onClick={() => onNavigate("emergency")}><AlertTriangle size={17} /> Emergency</button></div>
